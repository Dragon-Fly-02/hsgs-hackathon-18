...
const n20 = 
{
	...
	default(props = { Stepmoney:50,Steppeople:500,Stepsandwich:50,Stepmusic:50,Stepedu:50,Stepcrafts:50,Stepcoat:50,Stepbag:50}) 
	{
		...
		k = k - bag;
		return {money,people,sandwich,music,edu,crafts,coat,bag,ans_sandwich,ans_music,ans_edu,ans_crafts,ans_coat,ans_bag,money_sandwich,money_music,money_edu,money_crafts,money_coat,money_bag,sum};
	}, 
